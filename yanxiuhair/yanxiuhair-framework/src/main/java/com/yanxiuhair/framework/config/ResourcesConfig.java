...
import com.yanxiuhair.framework.interceptor.RepeatSubmitInterceptor;

/**
 * @ClassName:  ResourcesConfig   
 * @Description: 通用配置
 * @author: gaoxiaochuang   
 * @date:   2020年10月19日 上午10:15:04   
 *     
...
public class ResourcesConfig implements WebMvcConfigurer {
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler(Constants.RESOURCE_PORTAL_PREFIX + "/**").addResourceLocations("file:" + Global.getPortalProfile() + "/");
