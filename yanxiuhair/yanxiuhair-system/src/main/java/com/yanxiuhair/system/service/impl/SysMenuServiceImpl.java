...
import com.yanxiuhair.system.mapper.SysMenuMapper;
import com.yanxiuhair.system.mapper.SysRoleMenuMapper;
...
public class SysMenuServiceImpl implements ISysMenuService {
	...
	public List<SysMenu> selectMenuList2(SysMenu menu, Long userId) {
		...
		for (int i = menuList.size() - 1; i >= 0; i--) {
			SysMenu obj = menuList.get(i);
			if (hasChild(menuList, obj)) {
				recursionFn2(menuList, obj);
			}
		}
		return menuList;
	}
	 ...
	 * @param t
	 */
	private void recursionFn2(List<SysMenu> list, SysMenu t) {
		// 得到子节点列表
		List<SysMenu> childList = getChildList2(list, t);
	 ...
	 * 得到子节点列表
	 */
	private List<SysMenu> getChildList2(List<SysMenu> list, SysMenu t) {
