...
import com.yanxiuhair.common.annotation.Excels;
import com.yanxiuhair.common.annotation.Excel.ColumnType;
import com.yanxiuhair.common.annotation.Excel.Type;
...
public class SysUser extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("userId", getUserId())
				.append("deptId", getDeptId()).append("userDeptName", getUserDeptName()).append("loginName", getLoginName()).append("userName", getUserName())
